...
%% Image5_111013
filename = 'Image5_111013'
dir1 = '/Volumes/CORAVOS 1/LSM Microscopy/H2O Injections/Fixed/SqhGFP,Phall568,Ecad647/Image5_111013/'
membrane = strcat(dir1, filename, '_c003.tif');
tmod = strcat(dir1,filename,'_c001.tif'); %myo
mbs = strcat(dir1, filename,'_c002.tif'); %ecad
pc = 0.103; % pc is pixel conversion, microns per pixel 
...
%% Image14_111013
filename = 'Image14_111013'
dir1 = '/Volumes/CORAVOS 1/LSM Microscopy/H2O Injections/Fixed/SqhGFP,Phall568,Ecad647/Image14_111013/'
membrane = strcat(dir1, filename, '_c003.tif');
tmod = strcat(dir1,filename,'_c001.tif'); %myo
mbs = strcat(dir1, filename,'_c002.tif'); %ecad
pc = 0.094; % pc is pixel conversion, microns per pixel 
